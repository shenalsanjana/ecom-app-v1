# customer-account-menu Specification

## Purpose

Defines the storefront header's profile/account dropdown for customers: the
appearance of its trigger (a personalized initials avatar when signed in, a
generic icon as fallback) and the set of navigation destinations the dropdown
exposes to signed-in customers, admins, and signed-out visitors.
