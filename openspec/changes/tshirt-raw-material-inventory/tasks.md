...
- [x] 3.3 Build the `/admin/inventory` page and its Plain T-Shirt Stock grid + DTF Designs table components (Plan Task 11)
- [x] 3.4 Add "Inventory" to the admin nav (Plan Task 12)
...
- [x] 5.2 Rework the admin products low-stock tab (`getLowStockProductIds`/`resolveProductWhere`) and the "Total stock" column → "Available" badge (Plan Task 16)
...
- [x] 6.2 Wire `buy-box-client.tsx`, `product-jsonld.tsx`, and the PDP page onto the two pools (Plan Task 18)
- [x] 6.3 Wire the Meta catalog feed route onto the two pools (Plan Task 19)
