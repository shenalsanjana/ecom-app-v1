...
- [x] 2.2 Reconcile the `git-spec` skill (SKILL.md + reference doc) to main / feat-fix / Conventional Commits (plan Task 6)
- [x] 2.3 Promote shared plugins into committed `.claude/settings.json`; fix the dangling `/opsx:continue` reference (plan Task 9)

## 3. Docs

- [x] 3.1 Reframe `docs/commands/openspec.md` as the OPSX stage; fix `superpowers.md` file locations + real invocation (plan Task 7)
- [x] 3.2 Tidy `openspec/COMMIT_PROCESS.md` — add docs/test/perf types, test verification, worktree note (plan Task 8)
